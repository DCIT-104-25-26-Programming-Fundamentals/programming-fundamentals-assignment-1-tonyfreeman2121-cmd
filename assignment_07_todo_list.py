...
def view_tasks(tasks):
    """Print all tasks, numbered from 1. Show a message if the list is empty."""
    if not tasks:
...
def delete_task(tasks):
    """Show the tasks, ask which one to remove, and delete it."""
    if not tasks:
...
def main():
    """Run the to-do list program until the user chooses to quit."""
    tasks = []
